...
import { logPerformanceToConsole, PerformanceTimer } from '../utils/performanceLogger';
...
const useUiStore = create<UIStoreState & UIStoreInternalState>((set, get) => ({
  ...
  generateExportPreview: async (currentImageData: ImageDataInterface, params: ExportParams) => {
