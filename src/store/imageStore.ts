...
const useImageStore = create<ImageStoreState & ImageStoreInternalState>((set, get) => ({
  // 图像状态
  currentImage: null,
  originalImage: null,
  history: [],
  ...
  updateImage: (imageData: ImageDataInterface, operation?: string, params?: FilterParams) => {
    const historyManager = get().historyManager;
