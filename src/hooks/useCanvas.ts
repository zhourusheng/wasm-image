...
const useCanvas = (containerRef: RefObject<HTMLDivElement>): UseCanvasReturn => {
  ...
  // 获取画布坐标转换
  const getCanvasCoordinates = useCallback((e: MouseEvent | React.MouseEvent): CanvasCoordinates => {
