    ...
    switch (op) {
      ...
      case 'rotate': {
        ...
        self.cv.warpAffine(
          ...
          dst,
          matrix,
          new self.cv.Size(newWidth, newHeight)
        );
        matrix.delete();
        break;
      }
      ...
      case 'sepia': {
        ...
        self.cv.multiply(
          r,
          new self.cv.Mat(r.rows, r.cols, r.type(), new self.cv.Scalar(0.393)),
          r_r
        );
        self.cv.multiply(
          g,
          new self.cv.Mat(g.rows, g.cols, g.type(), new self.cv.Scalar(0.769)),
          r_g
        );
        self.cv.multiply(
          b,
          new self.cv.Mat(b.rows, b.cols, b.type(), new self.cv.Scalar(0.189)),
          r_b
        );
        ...
        self.cv.multiply(
          r,
          new self.cv.Mat(r.rows, r.cols, r.type(), new self.cv.Scalar(0.349)),
          g_r
        );
        self.cv.multiply(
          g,
          new self.cv.Mat(g.rows, g.cols, g.type(), new self.cv.Scalar(0.686)),
          g_g
        );
        self.cv.multiply(
          b,
          new self.cv.Mat(b.rows, b.cols, b.type(), new self.cv.Scalar(0.168)),
          g_b
        );
        ...
        self.cv.multiply(
          r,
          new self.cv.Mat(r.rows, r.cols, r.type(), new self.cv.Scalar(0.272)),
          b_r
        );
        self.cv.multiply(
          g,
          new self.cv.Mat(g.rows, g.cols, g.type(), new self.cv.Scalar(0.534)),
          b_g
        );
        self.cv.multiply(
          b,
          new self.cv.Mat(b.rows, b.cols, b.type(), new self.cv.Scalar(0.131)),
          b_b
        );
