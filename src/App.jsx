    ...
    <div className="flex flex-col h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 font-sans">
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className={`flex-1 flex overflow-hidden ${isCollageMode ? 'hidden' : 'flex'}`}>
          ...
          {activeTool && (
            <Suspense fallback={<div className="w-80 bg-white dark:bg-gray-800 border-l border-gray-300 dark:border-gray-600 flex items-center justify-center">
        ...
        {isCollageMode && (
          <Suspense fallback={<div className="flex-1 bg-white dark:bg-gray-800 flex items-center justify-center">
