opencvWasmBinaryFile = './opencv.wasm';
        ...
        return (
            function(cv) {
                ...
                function stringToUTF8(str, outPtr, maxBytesToWrite) {
                    return stringToUTF8Array(str, HEAP8, outPtr, maxBytesToWrite)
                }
                ...
                var STACK_BASE = 1544928,
                    DYNAMIC_BASE = 6787808,
                    DYNAMICTOP_PTR = 1544736;
